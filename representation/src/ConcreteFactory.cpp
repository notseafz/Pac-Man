...
sf::IntRect ConcreteFactory::getSpriteRect(const std::string& name) const { return spriteRects.at(name); }
...
const std::vector<std::shared_ptr<GhostView>>& ConcreteFactory::getGhostviews() const { return ghostviews; }
